...
def init_parser(alg):
    if alg == 'WOLP_DDPG':
        ...
        parser.add_argument('--max-episode-length', type=int, default=1440, metavar='M',
                            help='maximum length of an episode (default: 1440)')
        ...
        parser.add_argument('--weight-decay', default=0.0001, type=float,
                            help='weight decay for L2 Regularization loss')
